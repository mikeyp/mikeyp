...
function set_icon(t) {
    $(".mfp-close").click(), $(".icon_area").show(), $(".choose_icon_btn").hide(), $(".change_icon_link").show(), $("#setting_icon_id").val(t), $.ajax({
        url: "/settings/get_icon",
        type: "GET",
        data: "id=" + t,
        success: function (t) {
            $(".icon_area").html(t)
...
function getFile(t) {
    ...
    function r(t, i, n) {
        if (n === e && 1 === t.nodeType) {
            ...
            if (n = t.getAttribute(s), "string" == typeof n) {
                try {
                    n = "true" === n ? !0 : "false" === n ? !1 : "null" === n ? null : +n + "" === n ? +n : De.test(n) ? ue.parseJSON(n) : n
                } catch (o) {}
                ue.data(t, i, n)
            } else n = e
        }
    ...
    function k(t, e) {
        for (var i, n, s, o = [], r = 0, a = t.length; a > r; r++) n = t[r], n.style && (o[r] = ue._data(n, "olddisplay"), i = n.style.display, e ? (o[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && C(n) && (o[r] = ue._data(n, "olddisplay", P(n.nodeName)))) : o[r] || (s = C(n), (i && "none" !== i || !s) && ue._data(n, "olddisplay", s ? i : ue.css(n, "display"))));
    ...
    function D(t, e, i, n, s) {
        for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > o; o += 2) "margin" === i && (r += ue.css(t, i + Ci[o], !0, s)), n ? ("content" === i && (r -= ue.css(t, "padding" + Ci[o], !0, s)), "margin" !== i && (r -= ue.css(t, "border" + Ci[o] + "Width", !0, s))) : (r += ue.css(t, "padding" + Ci[o], !0, s), "padding" !== i && (r += ue.css(t, "border" + Ci[o] + "Width", !0, s)));
        return r
    }
    ...
    function S(t, e, i) {
        ...
        if (0 >= s || null == s) {
            if (s = ci(t, e, o), (0 > s || null == s) && (s = t.style[e]), yi.test(s)) return s;
    ...
    function P(t) {
        var e = K,
            i = _i[t];
        return i || (i = I(t, e), "none" !== i && i || (hi = (hi || ue("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(e.documentElement), e = (hi[0].contentWindow || hi[0].contentDocument).document, e.write("<!doctype html><html><body>"), e.close(), i = I(t, e), hi.detach()), _i[t] = i), i
    }
    ...
    function E(t, e, i, n) {
        ...
        if (ue.isArray(e)) ue.each(e, function (e, s) {
            i || Di.test(t) ? n(t, s) : E(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n)
        });
    ...
    function R(t, e, i) {
        var n, s, o = 0,
            ...
            l = function () {
                if (s) return !1;
                for (var e = Ji || L(), i = Math.max(0, h.startTime + h.duration - e), n = i / h.duration || 0, o = 1 - n, r = 0, l = h.tweens.length; l > r; r++) h.tweens[r].run(o);
            ...
            u = h.props;
        for (F(u, h.opts.specialEasing); r > o; o++)
            if (n = sn[o].call(h, t, u, h.opts)) return n;
        return ue.map(u, j, h), ue.isFunction(h.opts.start) && h.opts.start.call(t, h), ue.fx.timer(ue.extend(l, {
            elem: t,
            anim: h,
            queue: h.opts.queue
    ...
    function B(t, e, i) {
        ...
        })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [c.overflow, c.overflowX, c.overflowY], "inline" === ue.css(t, "display") && "none" === ue.css(t, "float") && (ue.support.inlineBlockNeedsLayout && "inline" !== P(t.nodeName) ? c.zoom = 1 : c.display = "inline-block")), i.overflow && (c.overflow = "hidden", ue.support.shrinkWrapBlocks || h.always(function () {
        ...
        if (!ue.isEmptyObject(u)) {
            ...
            for (n in u) r = j(d ? p[n] : 0, n, h), n in p || (p[n] = r.start, d && (r.end = r.start, r.start = "width" === n || "height" === n ? 1 : 0))
        }
    }

    function $(t, e, i, n, s) {
        return new $.prototype.init(t, e, i, n, s)
    }
    ...
    var Y, U, X = typeof e,
        ...
        Ce = function (t) {
            (K.addEventListener || "load" === t.type || "complete" === K.readyState) && (ke(), ue.ready())
        },
        ke = function () {
            K.addEventListener ? (K.removeEventListener("DOMContentLoaded", Ce, !1), t.removeEventListener("load", Ce, !1)) : (K.detachEvent("onreadystatechange", Ce), t.detachEvent("onload", Ce))
        };
    ue.fn = ue.prototype = {
        jquery: ie,
        constructor: ue,
        init: function (t, i, n) {
            ...
            if ("string" == typeof t) {
                ...
                if (s[1]) {
                    if (i = i instanceof ue ? i[0] : i, ue.merge(this, ue.parseHTML(s[1], i && i.nodeType ? i.ownerDocument || i : K, !0)), me.test(s[1]) && ue.isPlainObject(i))
        ...
        ready: function (t) {
            if (t === !0 ? !--ue.readyWait : !ue.isReady) {
                ...
                ue.isReady = !0, t !== !0 && --ue.readyWait > 0 || (Y.resolveWith(K, [ue]), ue.fn.trigger && ue(K).trigger("ready").off("ready"))
            }
        },
        ...
        if (!Y)
            ...
            else if (K.addEventListener) K.addEventListener("DOMContentLoaded", Ce, !1), t.addEventListener("load", Ce, !1);
        else {
            K.attachEvent("onreadystatechange", Ce), t.attachEvent("onload", Ce);
            var i = !1;
            try {
    ...
    function (t, e) {
        function i(t, e, i, n) {
            var s, o, r, a, l, h, u, c, f, m;
            if ((e ? e.ownerDocument || e : R) !== A && M(e), e = e || A, i = i || [], !t || "string" != typeof t) return i;
            ...
            if (N && !n) {
                if (s = be.exec(t))
                    if (r = s[1]) {
                        ...
                        if ((r = s[3]) && C.getElementsByClassName && e.getElementsByClassName) return te.apply(i, e.getElementsByClassName(r)), i
                    }
                if (C.qsa && (!H || !H.test(t))) {
                    if (c = u = j, f = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (h = d(t), (u = e.getAttribute("id")) ? c = u.replace(xe, "\\$&") : e.setAttribute("id", c), c = "[id='" + c + "'] ", l = h.length; l--;) h[l] = c + p(h[l]);
                        f = pe.test(t) && e.parentNode || e, m = h.join(",")
                    }
                    if (m) try {
        ...
        function d(t, e) {
            ...
            for (a = t, l = [], h = T.preFilter; a;) {
                ...
                for (r in T.filter)!(s = ve[r].exec(a)) || h[r] && !(s = h[r](s)) || (n = s.shift(), o.push({
                    value: n,
                    type: r,
                    matches: s
                }), a = a.slice(n.length));
        ...
        function f(t, e, i) {
            ...
            return e.first ? function (e, i, o) {
                ...
                if (r) {
                    ...
                    for (; e = e[n];)
                        if (1 === e.nodeType || s)
                            if (h = e[j] || (e[j] = {}), (l = h[n]) && l[0] === u) {
                                if ((a = l[1]) === !0 || a === k) return a === !0
                            } else if (l = h[n] = [u], l[1] = t(e, i, r) || k, l[1] === !0) return !0
            }
        }
        ...
        function v(t, e, i, n, o, r) {
            return n && !n[j] && (n = v(n)), o && !o[j] && (o = v(o, r)), s(function (s, r, a, l) {
                var h, u, c, d = [],
                    p = [],
                    f = r.length,
                    ...
                    y = i ? o || (s ? t : f || n) ? [] : r : v;
                if (i && i(v, y, a, l), n)
                    for (h = g(y, p), n(h, [], a, l), u = h.length; u--;)(c = h[u]) && (y[p[u]] = !(v[p[u]] = c));
                if (s) {
                    if (o || t) {
                        if (o) {
                        ...
                        for (u = y.length; u--;)(c = y[u]) && (h = o ? ie.call(s, c) : d[u]) > -1 && (s[h] = !(r[h] = c))
                    }
                ...
                if (i = T.relative[t[a].type]) u = [f(m(u), i)];
                    ...
                    if (i = T.filter[t[a].type].apply(null, t[a].matches), i[j]) {
                        ...
                        return v(a > 1 && m(u), a > 1 && p(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(he, "$1"), i, n > a && y(t.slice(a, n)), s > n && y(t = t.slice(n)), s > n && p(t))
                    }
                    u.push(i)
                }
            return m(u)
        ...
        function b(t, e) {
            var n = 0,
                ...
                a = function (s, a, l, h, u) {
                    ...
                    for (b && (I = a !== A && a, k = n); null != (c = w[v]); v++) {
                        if (r && c) {
                            for (d = 0; p = t[d++];)
                                if (p(c, a, l)) {
                                    h.push(c);
                    ...
                    if (m += v, o && v !== m) {
                        ...
                        if (s) {
                            if (m > 0)
                                for (; v--;) y[v] || f[v] || (f[v] = J.call(h));
                            f = g(f)
                        }
                        te.apply(h, f), b && !s && f.length > 0 && m + e.length > 1 && i.uniqueSort(h)
                    }
                    return b && (F = x, I = _), y
                };
            return o ? s(a) : a
        ...
        function w(t, e, i, n) {
            var s, o, r, a, l, h = d(t);
            if (!n && 1 === h.length) {
                if (o = h[0] = h[0].slice(0), o.length > 2 && "ID" === (r = o[0]).type && C.getById && 9 === e.nodeType && N && T.relative[o[1].type]) {
                    if (e = (T.find.ID(r.matches[0].replace(Ce, ke), e) || [])[0], !e) return i;
                    t = t.slice(o.shift().value.length)
                }
                for (s = ve.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s], !T.relative[a = r.type]);)
                    if ((l = T.find[a]) && (n = l(r.matches[0].replace(Ce, ke), pe.test(o[0].type) && e.parentNode || e))) {
                        if (o.splice(s, 1), t = n.length && p(o), !t) return te.apply(i, n), i;
                        break
                    }
            }
            return P(t, h)(n, e, !N, i, pe.test(t)), i
        }
        var x, C, k, T, D, S, P, I, E, M, A, z, N, H, O, W, L, j = "sizzle" + -new Date,
            R = t.document,
            F = 0,
            B = 0,
            $ = n(),
        ...
        S = i.isXML = function (t) {
            ...
            var e = t ? t.ownerDocument || t : R,
                i = e.defaultView;
            return e !== A && 9 === e.nodeType && e.documentElement ? (A = e, z = e.documentElement, N = !S(e), i && i.attachEvent && i !== i.top && i.attachEvent("onbeforeunload", function () {
                M()
            ...
            }, O = [], H = [], (C.qsa = ye.test(e.querySelectorAll)) && (o(function (t) {
            ...
            })), (C.matchesSelector = ye.test(W = z.webkitMatchesSelector || z.mozMatchesSelector || z.oMatchesSelector || z.msMatchesSelector)) && o(function (t) {
                C.disconnectedMatch = W.call(t, "div"), W.call(t, "[s!='']:x"), O.push("!=", le)
            }), H = H.length && new RegExp(H.join("|")), O = O.length && new RegExp(O.join("|")), L = ye.test(z.contains) || z.compareDocumentPosition ? function (t, e) {
                ...
                if (e)
                    for (; e = e.parentNode;)
                        if (e === t) return !0;
                return !1
            }, U = z.compareDocumentPosition ? function (t, i) {
                if (t === i) return Y = !0, 0;
                var n = i.compareDocumentPosition && t.compareDocumentPosition && t.compareDocumentPosition(i);
                return n ? 1 & n || !C.sortDetached && i.compareDocumentPosition(t) === n ? t === e || L(R, t) ? -1 : i === e || L(R, i) ? 1 : E ? ie.call(E, t) - ie.call(E, i) : 0 : 4 & n ? -1 : 1 : t.compareDocumentPosition ? -1 : 1
            } : function (t, i) {
                var n, s = 0,
                    o = t.parentNode,
                    r = i.parentNode,
                    ...
                    h = [i];
                if (t === i) return Y = !0, 0;
                if (!o || !r) return t === e ? -1 : i === e ? 1 : o ? -1 : r ? 1 : E ? ie.call(E, t) - ie.call(E, i) : 0;
                if (o === r) return a(t, i);
            ...
            if ((t.ownerDocument || t) !== A && M(t), e = e.replace(fe, "='$1']"), !(!C.matchesSelector || !N || O && O.test(e) || H && H.test(e))) try {
                var n = W.call(t, e);
            ...
            var n = T.attrHandle[i.toLowerCase()],
                s = n && K.call(T.attrHandle, i.toLowerCase()) ? n(t, i, !N) : e;
            return s === e ? C.attributes || !N ? t.getAttribute(i) : (s = t.getAttributeNode(i)) && s.specified ? s.value : null : s
        }, i.error = function (t) {
            ...
            var e, i = [],
                n = 0,
                s = 0;
            if (Y = !C.detectDuplicates, E = !C.sortStable && t.slice(0), t.sort(U), Y) {
            ...
            filter: {
                ...
                CLASS: function (t) {
                    var e = $[t + " "];
                    return e || (e = new RegExp("(^|" + se + ")" + t + "(" + se + "|$)")) && $(t, function (t) {
                    ...
                    return 1 === n && 0 === s ? function (t) {
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild : g.lastChild], r && y) {
                                for (u = g[j] || (g[j] = {}), h = u[t] || [], p = h[0] === F && h[1], d = h[0] === F && h[2], c = p && g.childNodes[p]; c = ++p && c && c[m] || (d = p = 0) || f.pop();)
                                ...
                                for (;
                                    (c = ++p && c && c[m] || (d = p = 0) || f.pop()) && ((a ? c.nodeName.toLowerCase() !== v : 1 !== c.nodeType) || !++d || (y && ((c[j] || (c[j] = {}))[t] = [F, d]), c !== e)););
                            return d -= s, d === n || 0 === d % n && d / n >= 0
                        }
                    }
                },
                PSEUDO: function (t, e) {
                    var n, o = T.pseudos[t] || T.setFilters[t.toLowerCase()] || i.error("unsupported pseudo: " + t);
                    return o[j] ? o(e) : o.length > 1 ? (n = [t, t, "", e], T.setFilters.hasOwnProperty(t.toLowerCase()) ? s(function (t, i) {
        ...
        c.prototype = T.filters = T.pseudos, T.setFilters = new c, P = i.compile = function (t, e) {
            var i, n = [],
                s = [],
                o = V[t + " "];
            if (!o) {
            ...
            return o
        }, C.sortStable = j.split("").sort(U).join("") === j, C.detectDuplicates = Y, M(), C.sortDetached = o(function (t) {
    ...
    ue.Callbacks = function (t) {
        ...
        var i, n, s, o, r, a, l, h, u, c = K.createElement("div");
    ...
    ue.fn.extend({
        ...
        addClass: function (t) {
            ...
            if (l)
                for (e = (t || "").match(de) || []; a > r; r++)
                    if (i = this[r], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Ee, " ") : " ")) {
        ...
        val: function (t) {
            var i, n, s, o = this[0]; {
                ...
                if (o) return n = ue.valHooks[o.type] || ue.valHooks[o.nodeName.toLowerCase()], n && "get" in n && (i = n.get(o, "value")) !== e ? i : (i = o.value, "string" == typeof i ? i.replace(Me, "") : null == i ? "" : i)
            }
        }
    }), ue.extend({
        valHooks: {
        ...
        attr: function (t, i, n) {
            ...
            if (t && 3 !== r && 8 !== r && 2 !== r) return typeof t.getAttribute === X ? ue.prop(t, i, n) : (1 === r && ue.isXMLDoc(t) || (i = i.toLowerCase(), s = ue.attrHooks[i] || (ue.expr.match.bool.test(i) ? Ie : Pe)), n === e ? s && "get" in s && null !== (o = s.get(t, i)) ? o : (o = ue.find.attr(t, i), null == o ? e : o) : null !== n ? s && "set" in s && (o = s.set(t, n, i)) !== e ? o : (t.setAttribute(i, n + ""), n) : (ue.removeAttr(t, i), void 0))
        },
        removeAttr: function (t, e) {
            var i, n, s = 0,
                o = e && e.match(de);
            if (o && 1 === t.nodeType)
                for (; i = o[s++];) n = ue.propFix[i] || i, ue.expr.match.bool.test(i) ? Oe && He || !Ne.test(i) ? t[n] = !1 : t[ue.camelCase("default-" + i)] = t[n] = !1 : ue.attr(t, i, ""), t.removeAttribute(He ? i : n)
        },
        attrHooks: {
            type: {
                set: function (t, e) {
        ...
        propHooks: {
            tabIndex: {
                get: function (t) {
                    ...
                    return e ? parseInt(e, 10) : Ae.test(t.nodeName) || ze.test(t.nodeName) && t.href ? 0 : -1
                }
            }
        }
    }), Ie = {
        set: function (t, e, i) {
            return e === !1 ? ue.removeAttr(t, i) : Oe && He || !Ne.test(i) ? t.setAttribute(!He && ue.propFix[i] || i, i) : t[ue.camelCase("default-" + i)] = t[i] = !0, i
        }
    }, ue.each(ue.expr.match.bool.source.match(/\w+/g), function (t, i) {
        var n = ue.expr.attrHandle[i] || ue.find.attr;
        ue.expr.attrHandle[i] = Oe && He || !Ne.test(i) ? function (t, i, s) {
    ...
    }), Oe && He || (ue.attrHooks.value = {
        set: function (t, e, i) {
            return ue.nodeName(t, "input") ? (t.defaultValue = e, void 0) : Pe && Pe.set(t, e, i)
        }
    }), He || (Pe = {
        set: function (t, i, n) {
    ...
    ue.event = {
        ...
        add: function (t, i, n, s, o) {
            var r, a, l, h, u, c, d, p, f, m, g, v = ue._data(t);
            if (v) {
                for (n.handler && (h = n, n = h.handler, o = h.selector), n.guid || (n.guid = ue.guid++), (a = v.events) || (a = v.events = {}), (c = v.handle) || (c = v.handle = function (t) {
                ...
                }, c.elem = t), i = (i || "").match(de) || [""], l = i.length; l--;) r = Fe.exec(i[l]) || [], f = g = r[1], m = (r[2] || "").split(".").sort(), f && (u = ue.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = ue.event.special[f] || {}, d = ue.extend({
                    type: f,
                    origType: g,
                    data: s,
                    handler: n,
                    ...
                    namespace: m.join(".")
                }, h), (p = a[f]) || (p = a[f] = [], p.delegateCount = 0, u.setup && u.setup.call(t, s, m, c) !== !1 || (t.addEventListener ? t.addEventListener(f, c, !1) : t.attachEvent && t.attachEvent("on" + f, c))), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), ue.event.global[f] = !0);
                t = null
            }
        },
        remove: function (t, e, i, n, s) {
            var o, r, a, l, h, u, c, d, p, f, m, g = ue.hasData(t) && ue._data(t);
            if (g && (u = g.events)) {
                for (e = (e || "").match(de) || [""], h = e.length; h--;)
                    if (a = Fe.exec(e[h]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (c = ue.event.special[p] || {}, p = (n ? c.delegateType : c.bindType) || p, d = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = d.length; o--;) r = d[o], !s && m !== r.origType || i && i.guid !== r.guid || a && !a.test(r.namespace) || n && n !== r.selector && ("**" !== n || !r.selector) || (d.splice(o, 1), r.selector && d.delegateCount--, c.remove && c.remove.call(t, r));
                        l && !d.length && (c.teardown && c.teardown.call(t, f, g.handle) !== !1 || ue.removeEvent(t, p, g.handle), delete u[p])
                    } else
        ...
        trigger: function (i, n, s, o) {
            var r, a, l, h, u, c, d, p = [s || K],
                f = le.call(i, "type") ? i.type : i,
                m = le.call(i, "namespace") ? i.namespace.split(".") : [];
            if (l = c = s = s || K, 3 !== s.nodeType && 8 !== s.nodeType && !Re.test(f + ue.event.triggered) && (f.indexOf(".") >= 0 && (m = f.split("."), f = m.shift(), m.sort()), a = f.indexOf(":") < 0 && "on" + f, i = i[ue.expando] ? i : new ue.Event(f, "object" == typeof i && i), i.isTrigger = o ? 2 : 3, i.namespace = m.join("."), i.namespace_re = i.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, i.result = e, i.target || (i.target = s), n = null == n ? [i] : ue.makeArray(n, [i]), u = ue.event.special[f] || {}, o || !u.trigger || u.trigger.apply(s, n) !== !1)) {
                if (!o && !u.noBubble && !ue.isWindow(s)) {
                    for (h = u.delegateType || f, Re.test(h + f) || (l = l.parentNode); l; l = l.parentNode) p.push(l), c = l;
                    c === (s.ownerDocument || K) && p.push(c.defaultView || c.parentWindow || t)
                }
                for (d = 0;
        ...
        fix: function (t) {
            ...
            var e, i, n, s = t.type,
                o = t,
                r = this.fixHooks[s];
            for (r || (this.fixHooks[s] = r = je.test(s) ? this.mouseHooks : Le.test(s) ? this.keyHooks : {}), n = r.props ? this.props.concat(r.props) : this.props, t = new ue.Event(o), e = n.length; e--;) i = n[e], t[i] = o[i];
            return t.target || (t.target = o.srcElement || K), 3 === t.target.nodeType && (t.target = t.target.parentNode), t.metaKey = !!t.metaKey, r.filter ? r.filter(t, o) : t
        },
    ...
    }, ue.removeEvent = K.removeEventListener ? function (t, e, i) {
        ...
        setup: function () {
            return We.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (ue.event.add(this, "propertychange._change", function (t) {
                ...
                var e = t.target;
                We.test(e.nodeName) && !ue._data(e, "changeBubbles") && (ue.event.add(e, "change._change", function (t) {
        ...
        teardown: function () {
            return ue.event.remove(this, "._change"), !We.test(this.nodeName)
        }
    ...
    ue.fn.extend({
        ...
        closest: function (t, e) {
            for (var i, n = 0, s = this.length, o = [], r = qe.test(t) || "string" != typeof t ? ue(t, e || this.context) : 0; s > n; n++)
        ...
        ue.fn[t] = function (i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (s = ue.filter(n, s)), this.length > 1 && (Ve[t] || (s = ue.unique(s)), $e.test(t) && (s = s.reverse())), this.pushStack(s)
        }
    }), ue.extend({
    ...
    ri.optgroup = ri.option, ri.tbody = ri.tfoot = ri.colgroup = ri.caption = ri.thead, ri.th = ri.td, ue.fn.extend({
        text: function (t) {
            return ue.access(this, function (t) {
                return t === e ? ue.text(this) : this.empty().append((this[0] && this[0].ownerDocument || K).createTextNode(t))
        ...
        html: function (t) {
            return ue.access(this, function (t) {
                ...
                if (!("string" != typeof t || ti.test(t) || !ue.support.htmlSerialize && Xe.test(t) || !ue.support.leadingWhitespace && Qe.test(t) || ri[(Ge.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(Ke, "<$1></$2>");
                    try {
        ...
        domManip: function (t, e, i) {
            ...
            if (u && (l = ue.buildFragment(t, this[0].ownerDocument, !1, !i && this), n = l.firstChild, 1 === l.childNodes.length && (l = n), n)) {
                for (r = ue.map(_(l, "script"), m), o = r.length; u > h; h++) s = l, h !== d && (s = ue.clone(s, !0, !0), o && ue.merge(r, _(s, "script"))), e.call(this[h], s, h);
                if (o)
                    for (a = r[r.length - 1].ownerDocument, ue.map(r, g), h = 0; o > h; h++) s = r[h], ni.test(s.type || "") && !ue._data(s, "globalEval") && ue.contains(a, s) && (s.src ? ue._evalUrl(s.src) : ue.globalEval((s.text || s.textContent || s.innerHTML || "").replace(oi, "")));
                l = n = null
            }
            return this
        }
        ...
        buildFragment: function (t, e, i, n) {
            for (var s, o, r, a, l, h, u, c = t.length, d = p(e), f = [], m = 0; c > m; m++)
                if (o = t[m], o || 0 === o)
                    if ("object" === ue.type(o)) ue.merge(f, o.nodeType ? [o] : o);
                    else if (Ze.test(o)) {
                for (a = a || d.appendChild(e.createElement("div")), l = (Ge.exec(o) || ["", ""])[1].toLowerCase(), u = ri[l] || ri._default, a.innerHTML = u[1] + o.replace(Ke, "<$1></$2>") + u[2], s = u[0]; s--;) a = a.lastChild;
                if (!ue.support.leadingWhitespace && Qe.test(o) && f.push(e.createTextNode(Qe.exec(o)[0])), !ue.support.tbody)
            ...
            for (a && d.removeChild(a), ue.support.appendChecked || ue.grep(_(f, "input"), w), m = 0; o = f[m++];)
    ...
    ue.fn.extend({
        ...
        style: function (t, i, n, s) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (r = typeof n, "string" === r && (o = bi.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(ue.css(t, i)), r = "number"), !(null == n || "number" === r && isNaN(n) || ("number" !== r || ue.cssNumber[l] || (n += "px"), ue.support.clearCloneStyle || "" !== n || 0 !== i.indexOf("background") || (h[i] = "inherit"), a && "set" in a && (n = a.set(t, n, s)) === e))) try {
                    h[i] = n
                } catch (u) {}
            }
        },
        ...
        var s, o, r, a = n || ui(t),
            ...
            h = t.style;
        return a && ("" !== l || ue.contains(t.ownerDocument, t) || (l = ue.style(t, i)), yi.test(l) && gi.test(i) && (s = h.width, o = h.minWidth, r = h.maxWidth, h.minWidth = h.maxWidth = h.width = l, l = a.width, h.width = s, h.minWidth = o, h.maxWidth = r)), l
    }) : K.documentElement.currentStyle && (ui = function (t) {
        return t.currentStyle
    }, ci = function (t, i, n) {
        var s, o, r, a = n || ui(t),
            l = a ? a[i] : e,
            h = t.style;
        return null == l && h && h[i] && (l = h[i]), yi.test(l) && !fi.test(i) && (s = h.left, o = t.runtimeStyle, r = o && o.left, r && (o.left = t.currentStyle.left), h.left = "fontSize" === i ? "1em" : l, l = h.pixelLeft + "px", h.left = s, r && (o.left = r)), "" === l ? "auto" : l
    }), ue.each(["height", "width"], function (t, e) {
        ue.cssHooks[e] = {
            get: function (t, i, n) {
                return i ? 0 === t.offsetWidth && mi.test(ue.css(t, "display")) ? ue.swap(t, wi, function () {
                    return S(t, e, n)
                }) : S(t, e, n) : void 0
            },
            set: function (t, i, n) {
                var s = n && ui(t);
                return T(t, i, n ? D(t, e, n, ue.support.boxSizing && "border-box" === ue.css(t, "boxSizing", !1, s), s) : 0)
            }
        }
        ...
        ue.support.reliableMarginRight || (ue.cssHooks.marginRight = {
            ...
            ue.cssHooks[e] = {
                get: function (t, i) {
                    return i ? (i = ci(t, e), yi.test(i) ? ue(t).position()[e] + "px" : i) : void 0
                }
            }
        })
        ...
        ue.cssHooks[t + e] = {
            expand: function (i) {
                for (var n = 0, s = {}, o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) s[t + Ci[n] + e] = o[n] || o[n - 2] || o[0];
                return s
            }
    ...
    ue.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !ue(this).is(":disabled") && Ii.test(this.nodeName) && !Pi.test(t) && (this.checked || !ei.test(t))
            }).map(function (t, e) {
                var i = ue(this).val();
    ...
    Ei = Ri.exec(Mi.toLowerCase()) || [], ue.fn.load = function (t, i, n) {
        ...
        ajaxSetup: function (t, e) {
            return e ? z(z(t, ue.ajaxSettings), e) : z(ue.ajaxSettings, t)
        },
        ajaxPrefilter: M(Bi),
        ajaxTransport: M($i),
        ajax: function (t, i) {
            function n(t, i, n, s) {
                var o, c, y, b, w, C = i;
                2 !== _ && (_ = 2, l && clearTimeout(l), u = e, a = s || "", x.readyState = t > 0 ? 4 : 0, o = t >= 200 && 300 > t || 304 === t, n && (b = N(d, x, n)), b = H(d, b, x, o), o ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (ue.lastModified[r] = w), w = x.getResponseHeader("etag"), w && (ue.etag[r] = w)), 204 === t || "HEAD" === d.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = b.state, c = b.data, y = b.error, o = !y)) : (y = C, (t || !C) && (C = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (i || C) + "", o ? m.resolveWith(p, [c, C, x]) : m.rejectWith(p, [x, C, y]), x.statusCode(v), v = e, h && f.trigger(o ? "ajaxSuccess" : "ajaxError", [x, d, o ? c : y]), g.fireWith(p, [x, C]), h && (f.trigger("ajaxComplete", [x, d]), --ue.active || ue.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || Mi) + "").replace(Ni, "").replace(ji, Ei[1] + "//"), d.type = i.method || i.type || d.method || d.type, d.dataTypes = ue.trim(d.dataType || "*").toLowerCase().match(de) || [""], null == d.crossDomain && (s = Ri.exec(d.url.toLowerCase()), d.crossDomain = !(!s || s[1] === Ei[1] && s[2] === Ei[2] && (s[3] || ("http:" === s[1] ? "80" : "443")) === (Ei[3] || ("http:" === Ei[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ue.param(d.data, d.traditional)), A(Bi, d, i, x), 2 === _) return x;
            h = d.global, h && 0 === ue.active++ && ue.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Li.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (zi.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Hi.test(r) ? r.replace(Hi, "$1_=" + Ai++) : r + (zi.test(r) ? "&" : "?") + "_=" + Ai++)), d.ifModified && (ue.lastModified[r] && x.setRequestHeader("If-Modified-Since", ue.lastModified[r]), ue.etag[r] && x.setRequestHeader("If-None-Match", ue.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || i.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + qi + "; q=0.01" : "") : d.accepts["*"]);
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function (e, s) {
                    i = K.createElement("script"), i.async = !0, t.scriptCharset && (i.charset = t.scriptCharset), i.src = t.url, i.onload = i.onreadystatechange = function (t, e) {
    ...
    ue.ajaxSetup({
        ...
        jsonpCallback: function () {
            var t = Yi.pop() || ue.expando + "_" + Ai++;
            return this[t] = !0, t
        }
    }), ue.ajaxPrefilter("json jsonp", function (i, n, s) {
        var o, r, a, l = i.jsonp !== !1 && (Ui.test(i.url) ? "url" : "string" == typeof i.data && !(i.contentType || "").indexOf("application/x-www-form-urlencoded") && Ui.test(i.data) && "data");
        return l || "jsonp" === i.dataTypes[0] ? (o = i.jsonpCallback = ue.isFunction(i.jsonpCallback) ? i.jsonpCallback() : i.jsonpCallback, l ? i[l] = i[l].replace(Ui, "$1" + o) : i.jsonp !== !1 && (i.url += (zi.test(i.url) ? "&" : "?") + i.jsonp + "=" + o), i.converters["script json"] = function () {
            return a || ue.error(o + " was not called"), a[0]
        }, i.dataTypes[0] = "json", r = t[o], t[o] = function () {
            a = arguments
        }, s.always(function () {
            t[o] = r, i[o] && (i.jsonpCallback = n.jsonpCallback, Yi.push(o)), a && ue.isFunction(r) && r(a[0]), a = r = e
        }), "script") : void 0
    });
    var Xi, Qi, Ki = 0,
    ...
    ue.ajaxSettings.xhr = t.ActiveXObject ? function () {
        return !this.isLocal && O() || W()
    } : O, Qi = ue.ajaxSettings.xhr(), ue.support.cors = !!Qi && "withCredentials" in Qi, Qi = ue.support.ajax = !!Qi, Qi && ue.ajaxTransport(function (i) {
            ...
            return {
                send: function (s, o) {
                    ...
                    l.send(i.hasContent && i.data || null), n = function (t, s) {
                        ...
                        c && o(a, u, c, h)
                    }, i.async ? 4 === l.readyState ? setTimeout(n) : (r = ++Ki, Gi && (Xi || (Xi = {}, ue(t).unload(Gi)), Xi[r] = n), l.onreadystatechange = n) : n()
                },
                abort: function () {
                    n && n(e, !0)
                }
    ...
    ue.Animation = ue.extend(R, {
        ...
        run: function (t) {
            ...
            return this.pos = e = this.options.duration ? ue.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : $.propHooks._default.set(this), this
        }
        ...
        var i, n, s = {
            ...
            o = this[0],
            r = o && o.ownerDocument;
        if (r) return i = r.documentElement, ue.contains(i, o) ? (typeof o.getBoundingClientRect !== X && (s = o.getBoundingClientRect()), n = V(r), {
        ...
        ue.fn[t] = function (s) {
            return ue.access(this, function (t, s, o) {
                var r = V(t);
                return o === e ? r ? i in r ? r[i] : r.document.documentElement[s] : t[s] : (r ? r.scrollTo(n ? ue(r).scrollLeft() : o, n ? o : ue(r).scrollTop()) : t[s] = o, void 0)
...
function (t, e) {
    ...
    t.rails = i = {
        ...
        if (s.is(i.linkDisableSelector) && i.disableElement(s), s.data("remote") !== e) {
            if (!(!n.metaKey && !n.ctrlKey || o && "GET" !== o || r)) return !0;
...
function (t, e) {
    ...
    t.position = {
        ...
        return y = s(b), b[0].preventDefault && (e.at = "left top"), p = y.width, m = y.height, g = y.offset, v = t.extend({}, g), t.each(["my", "at"], function () {
            ...
            1 === n.length && (n = h.test(n[0]) ? n.concat(["center"]) : u.test(n[0]) ? ["center"].concat(n) : ["center", "center"]), n[0] = h.test(n[0]) ? n[0] : "center", n[1] = u.test(n[1]) ? n[1] : "center", t = c.exec(n[0]), i = c.exec(n[1]), C[this] = [t ? t[0] : 0, i ? i[0] : 0], e[this] = [d.exec(n[0])[0], d.exec(n[1])[0]]
            ...
            var s, h, u = t(this),
                ...
                f = n(this, "marginLeft"),
                y = n(this, "marginTop"),
                k = c + f + n(this, "marginRight") + w.width,
                T = d + y + n(this, "marginBottom") + w.height,
                D = t.extend({}, v),
                S = i(C.my, u.outerWidth(), u.outerHeight());
            "right" === e.my[0] ? D.left -= c : "center" === e.my[0] && (D.left -= c / 2), "bottom" === e.my[1] ? D.top -= d : "center" === e.my[1] && (D.top -= d / 2), D.left += S[0], D.top += S[1], t.support.offsetFractions || (D.left = l(D.left), D.top = l(D.top)), s = {
                marginLeft: f,
                marginTop: y
                ...
                c > p && p > a(i + n) && (l.horizontal = "center"), d > m && m > a(s + o) && (l.vertical = "middle"), l.important = r(a(i), a(n)) > r(a(s), a(o)) ? "horizontal" : "vertical", e.using.call(this, t, l)
            }), u.offset(t.extend(D, {
                using: h
            }))
        })
        ...
        flip: {
            ...
            top: function (t, e) {
                var i, n, s = e.within,
                    ...
                    m = -2 * e.offset[1];
                0 > u ? (n = t.top + p + f + m + e.collisionHeight - r - o, t.top + p + f + m > u && (0 > n || a(u) > n) && (t.top += p + f + m)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l, t.top + p + f + m > c && (i > 0 || c > a(i)) && (t.top += p + f + m))
            }
        },
        flipfit: {
            left: function () {
...
function (t) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        drag: function (e, i) {
            ...
            for (c = p.snapElements.length - 1; c >= 0; c--) a = p.snapElements[c].left, l = a + p.snapElements[c].width, h = p.snapElements[c].top, u = h + p.snapElements[c].height, a - m > v || g > l + m || h - m > b || y > u + m || !t.contains(p.snapElements[c].item.ownerDocument, p.snapElements[c].item) ? (p.snapElements[c].snapping && p.options.snap.release && p.options.snap.release.call(p.element, e, t.extend(p._uiHash(), {
                snapItem: p.snapElements[c].item
            })), p.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(h - b), s = m >= Math.abs(u - y), o = m >= Math.abs(a - v), r = m >= Math.abs(l - g), n && (i.position.top = p._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left - p.margins.left)), d = n || s || o || r, "outer" !== f.snapMode && (n = m >= Math.abs(h - y), s = m >= Math.abs(u - b), o = m >= Math.abs(a - g), r = m >= Math.abs(l - v), n && (i.position.top = p._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top - p.margins.top), s && (i.position.top = p._convertPositionTo("relative", {
...
function (t) {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        resize: function () {
            ...
            i.grid = a, g && (d += l), v && (p += h), f && (d -= l), m && (p -= h), /^(se|s|e)$/.test(r) ? (e.size.width = d, e.size.height = p) : /^(ne)$/.test(r) ? (e.size.width = d, e.size.height = p, e.position.top = o.top - c) : /^(sw)$/.test(r) ? (e.size.width = d, e.size.height = p, e.position.left = o.left - u) : (e.size.width = d, e.size.height = p, e.position.top = o.top - c, e.position.left = o.left - u)
        }
    })
}(jQuery),
function (t) {
        ...
        _contactContainers: function (n) {
            ...
            if (f)
                if (1 === this.containers.length) this.containers[m].containerCache.over || (this.containers[m]._trigger("over", n, this._uiHash(this)), this.containers[m].containerCache.over = 1);
                    ...
                    for (r = 1e4, a = null, p = f.floating || i(this.currentItem), l = p ? "left" : "top", h = p ? "width" : "height", u = this.positionAbs[l] + this.offset.click[l], o = this.items.length - 1; o >= 0; o--) t.contains(this.containers[m].element[0], this.items[o].item[0]) && this.items[o].item[0] !== this.currentItem[0] && (!p || e(this.positionAbs.top + this.offset.click.top, this.items[o].top, this.items[o].height)) && (c = this.items[o].item.offset()[l], d = !1, Math.abs(c - u) > Math.abs(c + this.items[o][h] - u) && (d = !0, c += this.items[o][h]), r > Math.abs(c - u) && (r = Math.abs(c - u), a = this.items[o], this.direction = d ? "up" : "down"));
...
function (t, e) {
    ...
    t.extend(i.prototype, {
        ...
        _generateHTML: function (t) {
            var e, i, n, s, o, r, a, l, h, u, c, d, p, f, m, g, v, y, b, _, w, x, C, k, T, D, S, P, I, E, M, A, z, N, H, O, W, L, j, R = new Date,
            ...
            for (t.drawMonth = Z, t.drawYear = te, i = this._get(t, "prevText"), i = V ? this.formatDate(i, this._daylightSavingAdjust(new Date(te, Z - X, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, te, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(t, "nextText"), s = V ? this.formatDate(s, this._daylightSavingAdjust(new Date(te, Z + X, 1)), this._getFormatConfig(t)) : s, o = this._canAdjustMonth(t, 1, te, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + s + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + s + "</span></a>", r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? K : F, r = V ? this.formatDate(r, a, this._getFormatConfig(t)) : r, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = $ ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (B ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (B ? "" : l) + "</div>" : "", u = parseInt(this._get(t, "firstDay"), 10), u = isNaN(u) ? 0 : u, c = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), y = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), _ = "", x = 0; Y[0] > x; x++) {
                for (C = "", this.maxRows = 4, k = 0; Y[1] > k; k++) {
                    if (T = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay)), D = " ui-corner-all", S = "", Q) {
                    ...
                    for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === x ? B ? o : n : "") + (/all|right/.test(D) && 0 === x ? B ? n : o : "") + this._generateMonthYearHeader(t, Z, te, G, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", P = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) I = (w + u) % 7, P += "<th" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + d[I] + "'>" + p[I] + "</span></th>";
                    for (S += P + "</tr></thead><tbody>", E = this._getDaysInMonth(te, Z), te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, E)), M = (this._getFirstDayOfMonth(te, Z) - u + 7) % 7, A = Math.ceil((M + E) / 7), z = Q ? this.maxRows > A ? this.maxRows : A : A, this.maxRows = z, N = this._daylightSavingAdjust(new Date(te, Z, 1 - M)), H = 0; z > H; H++) {
                        for (S += "<tr>", O = c ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(N) + "</td>" : "", w = 0; 7 > w; w++) W = g ? g.apply(t.input ? t.input[0] : null, [N]) : [!0, ""], L = N.getMonth() !== Z, j = L && !y || !W[0] || G && G > N || J && N > J, O += "<td class='" + ((w + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (L ? " ui-datepicker-other-month" : "") + (N.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === N.getTime() && b.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (j ? " " + this._unselectableClass + " ui-state-disabled" : "") + (L && !v ? "" : " " + W[1] + (N.getTime() === K.getTime() ? " " + this._currentClass : "") + (N.getTime() === F.getTime() ? " ui-datepicker-today" : "")) + "'" + (L && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (j ? "" : " data-handler='selectDay' data-event='click' data-month='" + N.getMonth() + "' data-year='" + N.getFullYear() + "'") + ">" + (L && !v ? "&#xa0;" : j ? "<span class='ui-state-default'>" + N.getDate() + "</span>" : "<a class='ui-state-default" + (N.getTime() === F.getTime() ? " ui-state-highlight" : "") + (N.getTime() === K.getTime() ? " ui-state-active" : "") + (L ? " ui-priority-secondary" : "") + "' href='#'>" + N.getDate() + "</a>") + "</td>", N.setDate(N.getDate() + 1), N = this._daylightSavingAdjust(N);
                        S += O + "</tr>"
                    }
                    Z++, Z > 11 && (Z = 0, te++), S += "</tbody></table>" + (Q ? "</div>" + (Y[0] > 0 && k === Y[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), C += S
                }
                _ += C
            }
...
function (t) {
    var e = {
            init: function (e) {
                ...
                }), e && t.extend(n, e), n.color = t("<div style='background:" + n.color + "'></div>").css("background-color"), !0 !== n.repeat && !isNaN(n.repeat) && 0 < n.repeat && (n.repeat -= 1), this.each(function () {
        ...
        i = function (e, n, s) {
            ...
            var r = (o - s) / o,
                a = e.color.split(","),
                r = "rgba(" + a[0].split("(")[1] + "," + a[1] + "," + a[2].split(")")[0] + "," + r + ")",
                a = {
                    outline: "2px solid " + r
                };
            e.glow ? (a["box-shadow"] = "0px 0px " + parseInt(s / 1.5) + "px " + r, userAgent = navigator.userAgent || "", /(chrome)[ \/]([\w.]+)/.test(userAgent.toLowerCase()) && (a["outline-offset"] = s + "px", a["outline-radius"] = "100 px")) : a["outline-offset"] = s + "px", t(n).css(a), n.timer = setTimeout(function () {
                if (s >= o && !e.repeat) return t(n).pulsate("destroy"), !1;
                if (s >= o && !0 !== e.repeat && !isNaN(e.repeat) && 0 < e.repeat) e.repeat -= 1;
                else if (e.pause && s >= o) {
                    var r = s + 1;
                    return innerfunc = function () {
                        i(e, n, r)
                    }, setTimeout(innerfunc, e.pause), !1
                }
                i(e, n, s + 1)
            }, e.speed / o)
        };
    t.fn.pulsate = function (i) {
        return e[i] ? e[i].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof i && i ? (t.error("Method " + i + " does not exist on jQuery.pulsate"), void 0) : e.init.apply(this, arguments)
    }
}(jQuery),
function (t, e) {
    ...
    function i(t, e, i, n) {
        var s = ["opacity", e, ~~ (100 * t), i, n].join("-"),
            ...
            a = h.substring(0, h.indexOf("Animation")).toLowerCase(),
            l = a && "-" + a + "-" || "";
        return c[s] || (d.insertRule("@" + l + "keyframes " + s + "{" + "0%{opacity:" + r + "}" + o + "%{opacity:" + t + "}" + (o + .01) + "%{opacity:1}" + (o + e) % 100 + "%{opacity:" + t + "}" + "100%{opacity:" + r + "}" + "}", d.cssRules.length), c[s] = 1), s
    }
    ...
    function n(t, e) {
        ...
        for (e = e.charAt(0).toUpperCase() + e.slice(1), n = 0; n < u.length; n++)
            if (i = u[n] + e, void 0 !== s[i]) return i
    }
    ...
    function a(t) {
        return "undefined" == typeof this ? new a(t) : (this.opts = o(t || {}, a.defaults, p), void 0)
    }
    ...
    function l() {
        ...
        d.addRule(".spin-vml", "behavior:url(#default#VML)"), a.prototype.lines = function (t, n) {
            function o() {
                return s(i("group", {
                    coordsize: h + " " + h,
                    coordorigin: -l + " " + -l
    ...
    a.defaults = {}, o(a.prototype, {
        spin: function (e) {
            ...
            if (e && (e.insertBefore(l, e.firstChild || null), n = r(e), i = r(l), s(l, {
                left: ("auto" == a.left ? n.x - i.x + (e.offsetWidth >> 1) : parseInt(a.left, 10) + u) + "px",
                top: ("auto" == a.top ? n.y - i.y + (e.offsetHeight >> 1) : parseInt(a.top, 10) + u) + "px"
            })), l.setAttribute("role", "progressbar"), o.lines(l, o.opts), !h) {
                var c, d = 0,
                ...
                ! function y() {
                    d++;
                    for (var t = 0; t < a.lines; t++) c = Math.max(1 - (d + (a.lines - t) * v) % m * g, a.opacity), o.opacity(l, t * a.direction + p, c, a);
        ...
        lines: function (n, o) {
            ...
            for (var a, l = 0, u = (o.lines - 1) * (1 - o.direction) / 2; l < o.lines; l++) a = s(t(), {
                position: "absolute",
                top: 1 + ~(o.width / 2) + "px",
                transform: o.hwaccel ? "translate3d(0,0,0)" : "",
                opacity: o.opacity,
                animation: h && i(o.opacity, o.trail, u + l * o.direction, o.lines) + " " + 1 / o.speed + "s linear infinite"
            }), o.shadow && e(a, s(r("#000", "0 0 4px #000"), {
                top: "2px"
            })), e(n, e(a, r(o.color, "0 0 1px rgba(0,0,0,.1)")));
            return n
        },
    ...
    return !n(f, "transform") && f.adj ? l() : h = n(f, "animation"), a
}),
function () {
    "use strict";
    ...
    i.getListeners = function (t) {
        ...
        for (s in r)
            if (r.hasOwnProperty(s))
                for (n = r[s].length; n--;) i = r[s][n], o = i.listener.apply(this, e || []), (o === this._getOnceReturnValue() || i.once === !0) && this.removeListener(t, r[s][n].listener);
        return this
...
function (t) {
    ...
    function s(t, i) {
        function s(t, i, r) {
            ...
            "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = n(t), this.options = e({}, this.options), "function" == typeof i ? r = i : e(this.options, i), r && this.on("always", r), this.getImages(), o && (this.jqDeferred = new o.Deferred);
            var a = this;
            setTimeout(function () {
                a.check()
            })
        ...
        s.prototype = new t, s.prototype.options = {}, s.prototype.getImages = function () {
            ...
            function t(t, s) {
                return e.options.debug && a && r.log("confirm", t, s), e.progress(t), i++, i === n && e.complete(), !0
            }
            var e = this,
                i = 0,
...
function (t, e) {
    ...
    var i, n = t.document,
        ...
        a = function (t) {
            ...
            for (var s = 0, a = r.length; a > s; s++)
                if (e = r[s] + t, "string" == typeof i[e]) return e
        },
        l = a("transform"),
        h = a("transitionProperty"),
        u = {
    ...
    if (s)
        for (i in u) s.hasOwnProperty(i) || s.addTest(i, u[i]);
    else {
        s = t.Modernizr = {
            _version: "1.6ish: miniModernizr for Isotope"
        };
        var c, d = " ";
        for (i in u) c = u[i](), s[i] = c, d += " " + (c ? "" : "no-") + i;
        e("html").addClass(d)
    } if (s.csstransforms) {
        var p = s.csstransforms3d ? {
            ...
            f = function (t, i, n) {
                var s, o, r = e.data(t, "isoTransform") || {},
                    ...
                    h = {};
                a[i] = n, e.extend(r, a);
                for (s in r) o = r[s], h[s] = p[s](o);
                var u = h.translate || "",
                    c = h.scale || "",
                    d = u + c;
                e.data(t, "isoTransform", r), t.style[l] = d
            };
    ...
    e.Isotope.settings = {
        ...
        _create: function (t) {
            ...
            for (var o = 0, r = n.length; r > o; o++) s = n[o], this.originalStyle[s] = i[s] || "";
        ...
        option: function (t) {
            if (e.isPlainObject(t)) {
                ...
                var i;
                for (var n in t) i = "_update" + o(n), this[i] && this[i]()
            }
        },
        ...
        _sort: function () {
            var t = this.options.sortBy,
                ...
                n = function (n, s) {
                    var o = e(n, t),
                        r = e(s, t);
                    return o === r && "original-order" !== t && (o = e(n, "original-order"), r = e(s, "original-order")), (o > r ? 1 : r > o ? -1 : 0) * i
                };
        ...
        _processStyleQueue: function (t, i) {
            var n, o, r, a, l = this.isLaidOut ? this.isUsingJQueryAnimation ? "animate" : "css" : "css",
                h = this.options.animationOptions,
                u = this.options.onLayout;
            if (o = function (t, e) {
                e.$el[l](e.style, h)
            }, this._isInserting && this.isUsingJQueryAnimation) o = function (t, e) {
                n = e.$el.hasClass("no-transition") ? "css" : l, e.$el[n](e.style, h)
            };
            else if (i || u || h.complete) {
                var c = !1,
                    d = [i, u, h.complete],
                    p = this;
                if (r = !0, a = function () {
                    if (!c) {
                        for (var e, i = 0, n = d.length; n > i; i++) e = d[i], "function" == typeof e && e.call(p.element, t, p);
                        c = !0
                    }
                }, this.isUsingJQueryAnimation && "animate" === l) h.complete = a, r = !1;
                else if (s.csstransitions) {
                    for (var f, v = 0, y = this.styleQueue[0], b = y && y.$el; !b || !b.length;) {
                        if (f = this.styleQueue[v++], !f) return;
                        b = f.$el
                    }
                    var _ = parseFloat(getComputedStyle(b[0])[g]);
                    _ > 0 && (o = function (t, e) {
                        e.$el[l](e.style, h).one(m, a)
                    }, r = !1)
                }
            }
        ...
        destroy: function () {
            ...
            this.element.unbind(".isotope").undelegate("." + e.hiddenClass, "click").removeClass(e.containerClass).removeData("isotope"), w.unbind(".isotope")
        },
        _getSegments: function (t) {
            var e, i = this.options.layoutMode,
                ...
                r = t ? "rows" : "cols",
                a = this.element[s](),
                l = this.options[i] && this.options[i][n] || this.$filteredAtoms["outer" + o(s)](!0) || a;
            ...
            t.each(function () {
                ...
                if (s = Math.min(s, n.cols), 1 === s) i._masonryPlaceBrick(t, n.colYs);
                    ...
                    var o, r, a = n.cols + 1 - s,
                        l = [];
                    for (r = 0; a > r; r++) o = n.colYs.slice(r, r + s), l[r] = Math.max.apply(Math, o);
                    i._masonryPlaceBrick(t, l)
                }
            })
        },
        _masonryPlaceBrick: function (t, e) {
            for (var i = Math.min.apply(Math, e), n = 0, s = 0, o = e.length; o > s; s++)
                if (e[s] === i) {
                    n = s;
                    break
                }
            ...
            var l = i + t.outerHeight(!0),
                h = this.masonry.cols + 1 - o;
            for (s = 0; h > s; s++) this.masonry.colYs[n + s] = l
        },
            ...
            t.each(function () {
                ...
                if (s = Math.min(s, n.rows), 1 === s) i._masonryHorizontalPlaceBrick(t, n.rowXs);
                    ...
                    var o, r, a = n.rows + 1 - s,
                        l = [];
                    for (r = 0; a > r; r++) o = n.rowXs.slice(r, r + s), l[r] = Math.max.apply(Math, o);
        ...
        _masonryHorizontalPlaceBrick: function (t, e) {
            ...
            for (s = 0; h > s; s++) this.masonryHorizontal.rowXs[n + s] = l
        },
        ...
        function n(t) {
            var s = t.target;
            s.src !== a && -1 === e.inArray(s, l) && (l.push(s), --r <= 0 && (setTimeout(i), o.unbind(".imagesLoaded", n)))
        }
        var s = this,
            ...
            l = [];
        return r || i(), o.bind("load.imagesLoaded error.imagesLoaded", n).each(function () {
            var t = this.src;
    ...
    e.fn.isotope = function (t, i) {
        if ("string" == typeof t) {
            ...
            this.each(function () {
                ...
                return i ? e.isFunction(i[t]) && "_" !== t.charAt(0) ? (i[t].apply(i, n), void 0) : (x("no such method '" + t + "' for isotope instance"), void 0) : (x("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'"), void 0)
            })
    ...
    $(".sortable_entries").isotope({
        getSortData: {
            authorPosition: function (t) {
                return parseInt(t.attr("data-author-position"), 10)
            },
            chronological: function (t) {
                return parseInt(t.attr("data-chronological"), 10)
            }
        }
    }), $(".sort-by a").click(function () {
        var t = $(this).attr("href").slice(1);
        return $(".sortable_entries").isotope({
            sortBy: t
        }), !1
    }), $(".author_recommended_link").click(function () {
        $(this).addClass("dark_link"), $(".chronological_link").removeClass("dark_link")
    }), $(".chronological_link").click(function () {
        $(this).addClass("dark_link"), $(".author_recommended_link").removeClass("dark_link")
    });
    var t = $(".sortable_entries");
    t.isotope({
        resizable: !1,
        masonry: {
            columnWidth: t.width() / 5
        }
...
function (t) {
    t.slidebars = function (e) {
        function i() {
            !h.disableOver || "number" == typeof h.disableOver && h.disableOver >= x ? (w = !0, t("html").addClass("sb-init"), h.hideControlClasses && C.removeClass("sb-hide")) : "number" == typeof h.disableOver && h.disableOver < x && (w = !1, t("html").removeClass("sb-init"), h.hideControlClasses && C.addClass("sb-hide"), (y || _) && r())
        }

        function n() {
            g.css("minHeight", ""), g.css("minHeight", t("body").height() + "px"), v && (v.hasClass("sb-style-push") || v.hasClass("sb-style-overlay")) && v.css("marginLeft", "-" + v.css("width")), b && (b.hasClass("sb-style-push") || b.hasClass("sb-style-overlay")) && b.css("marginRight", "-" + b.css("width")), v && v.hasClass("sb-width-custom") && v.css("width", v.attr("data-sb-width")), b && b.hasClass("sb-width-custom") && b.css("width", b.attr("data-sb-width"))
        }

        function s(t, e, i) {
            var s;
            if (s = t.hasClass("sb-style-push") ? g.add(t).add(k) : t.hasClass("sb-style-overlay") ? t : g.add(k), "translate" === T) s.css("transform", "translate(" + e + ")");
            else if ("side" === T) "-" === e[0] && (e = e.substr(1)), s.css(i, e), setTimeout(function () {
                "0px" === e && (s.removeAttr("style"), n())
            }, 400);
            else if ("jQuery" === T) {
                "-" === e[0] && (e = e.substr(1));
                var o = {};
                o[i] = e, s.stop().animate(o, 400), setTimeout(function () {
                    "0px" === e && (s.removeAttr("style"), n())
                }, 400)
            }
        }
        ...
        function o(e) {
            function i() {
                w && "left" === e && v ? (t("html").addClass("sb-active sb-active-left"), v.addClass("sb-active"), s(v, v.css("width"), "left"), t(".sidebar_icon_trigger").length && t(".sidebar_icon_trigger").css("display", "none"), t(".user_banner").length && (t(".user_banner").css("position", "absolute"), t(".user_banner").css("min-height", t(window).height()), t(".shade").css("position", "absolute"), t(".shade").css("z-index", "0")), t(".social").length && t(".social").hide(700), setTimeout(function () {
                    y = !0
                }, 400)) : w && "right" === e && b && (t("html").addClass("sb-active sb-active-right"), b.addClass("sb-active"), s(b, "-" + b.css("width"), "right"), setTimeout(function () {
                    _ = !0
                }, 400))
            }
            "left" === e && v && _ || "right" === e && b && y ? (r(), setTimeout(i, 400)) : i()
        }

        function r(e) {
            (y || _) && (y && (s(v, "0px", "left"), y = !1), _ && (s(b, "0px", "right"), _ = !1), setTimeout(function () {
                t("html").removeClass("sb-active sb-active-left sb-active-right"), v && v.removeClass("sb-active"), b && b.removeClass("sb-active"), "translate" === T && g.css("transform", "none"), t(".sidebar_icon_trigger").length && (t(".sidebar_icon_trigger").css("display", "block"), t(".sidebar_icon_trigger").addClass("animated"), t(".sidebar_icon_trigger").addClass("fadeInMenu")), t(".social").length && t(window).width() >= 800 && (t(".social").css("position", "absolute"), t(".social").show(700)), e && (window.location = e)
            }, 400))
        }

        function a(t) {
            "left" === t && v && (y ? r() : o("left")), "right" === t && b && (_ ? r() : o("right"))
        }
        ...
        var h = t.extend({
            ...
            c = !1,
            d = !1;
        ("" === u.MozTransition || "" === u.WebkitTransition || "" === u.OTransition || "" === u.transition) && (c = !0), ("" === u.MozTransform || "" === u.WebkitTransform || "" === u.OTransform || "" === u.transform) && (d = !0);
        var p = navigator.userAgent,
            f = !1,
            m = !1;
        /Android/.test(p) ? f = p.substr(p.indexOf("Android") + 8, 3) : /(iPhone|iPod|iPad)/.test(p) && (m = p.substr(p.indexOf("OS ") + 3, 3).replace("_", ".")), (f && 3 > f || m && 5 > m) && t("html").addClass("sb-static"), t("#sb-site").length || t("body").children().wrapAll('<div id="sb-site" />');
        var g = t("#sb-site");
        if (g.parent().is("body") || g.appendTo("body"), t(".sb-left").length) {
            var v = t(".sb-left"),
                y = !1;
            v.addClass("sb-slidebar"), v.parent().is("body") || v.appendTo("body")
        }
        if (t(".sb-right").length) {
            var b = t(".sb-right"),
                _ = !1;
            b.addClass("sb-slidebar"), b.parent().is("body") || b.appendTo("body")
        }
        var w = !1,
            x = t(window).width(),
            C = t(".sb-toggle-left, .sb-toggle-right, .sb-open-left, .sb-open-right, .sb-close"),
            k = t(".sb-slide");
        i(), n(), t(window).resize(function () {
            var e = t(window).width();
            x !== e && (x = e, i(), n(), y && o("left"), _ && o("right"))
        });
        var T;
        c && d ? (T = "translate", f && 4.4 > f && (T = "side")) : T = "jQuery", this.open = o, this.close = r, this.toggle = a, this.init = function () {
            return w
        }, this.active = function (t) {
            return "left" === t && v ? y : "right" === t && b ? _ : void 0
            ...
            l(e, t(this)), r()
        }), t(".sb-slidebar a").not(".sb-disable-close").on("click", function (e) {
            l(e, t(this)), r(t(this).attr("href"))
        }), g.on("touchend click", function (e) {
            h.siteClose && (y || _) && (l(e, t(this)), r())
        })
    }
}(jQuery),
function (t) {
    ...
    var e, i = {
        ...
        o = t(n).data("autosize", !0)[0];
    o.style.lineHeight = "99px", "99px" === t(o).css("lineHeight") && s.push("lineHeight"), o.style.lineHeight = "", t.fn.autosize = function (n) {
        return n = t.extend({}, i, n || {}), o.parentNode !== document.body && t(document.body).append(o), this.each(function () {
            function i() {
                var e, i;
                "getComputedStyle" in window ? (e = window.getComputedStyle(d), i = d.getBoundingClientRect().width, t.each(["paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth"], function (t, n) {
                    i -= parseInt(e[n], 10)
                }), o.style.width = i + "px") : o.style.width = Math.max(p.width(), 0) + "px"
            }

            function r() {
                var r = {};
                if (e = d, o.className = n.className, h = parseInt(p.css("maxHeight"), 10), t.each(s, function (t, e) {
                    r[e] = p.css(e)
                }), t(o).css(r), i(), window.chrome) {
                    var a = d.style.width;
            ...
            function a() {
                var t, s;
                e !== d ? r() : i(), o.value = d.value + n.append, o.style.overflowY = d.style.overflowY, s = parseInt(d.style.height, 10), o.scrollTop = 0, o.scrollTop = 9e4, t = o.scrollTop, h && t > h ? (d.style.overflowY = "scroll", t = h) : (d.style.overflowY = "hidden", u > t && (t = u)), t += f, s !== t && (d.style.height = t + "px", m && n.callback.call(d, d))
            }
            ...
            }) : p.on("input.autosize", a), n.resizeDelay !== !1 && t(window).on("resize.autosize", l), p.on("autosize.resize", a), p.on("autosize.resizeIncludeStyle", function () {
                e = null, a()
            }), p.on("autosize.destroy", function () {
                e = null, clearTimeout(c), t(window).off("resize", l), p.off("autosize").off(".autosize").css(g).removeData("autosize")
            }), a())
        })
    }
}),
...
function (t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var h = l.isBorderBox = !(!a || !n[a] || "border-box" !== n[a]), u = 0, c = r.length; c > u; u++) {
                    var d = r[u],
                        p = n[d],
                        f = parseFloat(p);
                    l[d] = isNaN(f) ? 0 : f
                ...
                var m = l.paddingLeft + l.paddingRight,
                    ...
                    w = h && s,
                    x = e(n.width);
                x !== !1 && (l.width = x + (w ? 0 : m + b));
                var C = e(n.height);
                return C !== !1 && (l.height = C + (w ? 0 : g + _)), l.innerWidth = l.width - (m + b), l.innerHeight = l.height - (g + _), l.outerWidth = l.width + v, l.outerHeight = l.height + y, l
            }
        }
        var s, a = t("boxSizing");
        return function () {
    ...
    var s = document.defaultView,
        o = s && s.getComputedStyle ? function (t) {
...
function (t) {
    ...
    function s(t, s, o) {
        ...
        a.prototype._transitionTo = function (t, e) {
            ...
            if (this.setPosition(t, e), r && !this.isTransitioning) return this.layoutPosition(), void 0;
            var a = t - i,
                l = e - n,
                h = {},
    ...
    "function" == typeof define && define.amd ? define(["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property"], s) : (t.Outlayer = {}, t.Outlayer.Item = s(t.EventEmitter, t.getSize, t.getStyleProperty))
}(window),
function (t) {
    "use strict";
    ...
    function r(i, r, c, p, f, m) {
        function g(t, i) {
            if ("string" == typeof t && (t = a.querySelector(t)), !t || !d(t)) return l && l.error("Bad " + this.settings.namespace + " element: " + t), void 0;
        ...
        return g.prototype.settings = {
            ...
            for (var e = this._filterFindItemElements(t), i = this.settings.item, n = [], s = 0, o = e.length; o > s; s++) {
                var r = e[s],
                    a = new i(r, this);
                n.push(a)
            }
            ...
            for (var i = [], n = 0, s = t.length; s > n; n++) {
                ...
                r.item = o, r.isInstant = e, i.push(r)
            }
            ...
            return e(n.prototype, g.prototype), v(n, "options"), v(n, "settings"), e(n.prototype.options, i), n.prototype.settings.namespace = t, n.data = g.data, n.Item = function () {
...
function (t) {
    ...
    function e(t, e) {
        ...
        return n.prototype._resetLayout = function () {
            ...
            for (var n = this._getColGroup(e), s = Math.min.apply(Math, n), o = i(n, s), r = {
                x: this.columnWidth * o,
                y: s
            }, a = s + t.size.outerHeight, l = this.cols + 1 - n.length, h = 0; l > h; h++) this.colYs[o + h] = a;
            return r
...
function (t) {
    ...
    _.prototype = {
        ...
        open: function (i) {
            ...
            } else e.items = t.isArray(i.items) ? i.items : [i.items], e.index = i.index || 0; if (e.isOpen) return e.updateItemHTML(), void 0;
            ...
            T("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (C(d, function (t, e, i, n) {
            ...
            e.fixedContentPos && (e.isIE7 ? t("body, html").css("overflow", "hidden") : c.overflow = "hidden");
            var m = e.st.mainClass;
            e.isIE7 && (m += " mfp-ie7"), m && e._addClassToMFP(m), e.updateItemHTML(), T("BuildControls"), t("html").css(c), e.bgOverlay.add(e.wrap).prependTo(document.body), e._lastFocusedEl = document.activeElement, setTimeout(function () {
                e.content ? (e._addClassToMFP(v), D()) : e.bgOverlay.addClass(v), s.on("focusin" + g, function (i) {
                    return i.target === e.wrap[0] || t.contains(e.wrap[0], i.target) ? void 0 : (D(), !1)
                })
            }, 16), e.isOpen = !0, e.updateSize(u), T(p)
        },
        close: function () {
            e.isOpen && (T(h), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(y), setTimeout(function () {
                e._close()
        ...
        updateItemHTML: function () {
            ...
            if (T("BeforeChange", [e.currItem ? e.currItem.type : "", n]), e.currItem = i, !e.currTemplate[n]) {
                ...
                T("FirstMarkupParse", s), e.currTemplate[n] = s ? t(s) : !0
            }
            o && o !== i.type && e.container.removeClass("mfp-" + o + "-holder");
            var r = e["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, e.currTemplate[n]);
            e.appendContent(r, n), i.preloaded = !0, T(f, i), o = i.type, e.container.prepend(e.contentContainer), T("AfterChange")
        },
        appendContent: function (t, i) {
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0 ? e.content.find(".mfp-close").length || e.content.append(S()) : e.content = t : e.content = "", T(c), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        },
        parseEl: function (i) {
            var n = e.items[i],
                s = n.type;
        ...
        updateStatus: function (t, n) {
            if (e.preloader) {
                ...
                T("UpdateStatus", s), t = s.status, n = s.text, e.preloader.html(n), e.preloader.find("a").on("click", function (t) {
        ...
        _parseMarkup: function (e, i, n) {
            var s;
            n.data && (i = t.extend(n.data, i)), T(d, [e, i, n]), t.each(i, function (t, i) {
        ...
        modules: [],
        open: function (t, e) {
            return P(), t || (t = {}), t.isObj = !0, t.index = e || 0, this.instance.open(t)
        },
        close: function () {
        ...
        else w ? n.data("magnificPopup", i) : n[0].magnificPopup = i, e.addGroup(n, i);
        return n
    };
    var M, A, z, N = "inline",
        H = function () {
            z && (A.after(z.addClass(M)).detach(), z = null)
        };
            ...
            getInline: function (i, n) {
                if (H(), i.src) {
                    ...
                    if (o.length) {
                        ...
                        r && r.tagName && (A || (M = s.hiddenClass, A = k(M), M = "mfp-" + M), z = o.after(A).detach().removeClass(M)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(W, {
        ...
        proto: {
            initAjax: function () {
                e.types.push(W), O = e.st.ajax.cursor, C(l + "." + W, function () {
                    L(), e.req && e.req.abort()
                })
            },
            getAjax: function (i) {
                ...
                var s = t.extend({
                    ...
                    success: function (n, s, o) {
                        ...
                        T("ParseAjax", r), e.appendContent(t(r.data), W), i.finished = !0, L(), D(), setTimeout(function () {
                            e.wrap.addClass(v)
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function (i, n) {
                var s = 0,
                    o = function () {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, T("ImageLoadComplete")) : (s++, 200 > s ? setTimeout(o, 100) : r()))
                    },
                    r = function () {
                ...
                if (l.length) {
                    ...
                    h.className = "mfp-img", i.img = t(h).on("load.mfploader", o).on("error.mfploader", r), h.src = i.src, l.is("img") && (i.img = i.img.clone()), i.img[0].naturalWidth > 0 && (i.hasSize = !0)
                }
    ...
    t.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function () {
                ...
                if (t.enabled && e.supportsTransition) {
                    var n, s, o = t.duration,
                        r = function (e) {
                            var i = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                                ...
                                o = "transition";
                            return s["-webkit-" + o] = s["-moz-" + o] = s["-o-" + o] = s[o] = n, i.css(s), i
                        },
                        a = function () {
                    ...
                    C("BuildControls" + i, function () {
                        if (e._allowZoom()) {
                            if (clearTimeout(n), e.content.css("visibility", "hidden"), image = e._getItemToZoom(), !image) return a(), void 0;
                            s = r(image), s.css(e._getOffset()), e.wrap.append(s), n = setTimeout(function () {
                                s.css(e._getOffset(!0)), n = setTimeout(function () {
                                    a(), setTimeout(function () {
                                        s.remove(), image = s = null, T("ZoomAnimationEnded")
                                    }, 16)
                                }, o)
                            }, 16)
                        }
                        ...
                        if (e._allowZoom()) {
                            if (clearTimeout(n), e.st.removalDelay = o, !image) {
            ...
            _getOffset: function (i) {
                ...
                return B() ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, a.top = s.top), a
            }
        }
    })
    ...
    $(".open-popup-link").magnificPopup({
        ...
        alignTop: !0,
        mainClass: "mfp-fade"
    }), $(".open-settings-form").magnificPopup({
        type: "inline",
        midClick: !0,
        removalDelay: 300,
        alignTop: !0,
        mainClass: "mfp-fade"
    }), $(".open-image-form").magnificPopup({
        type: "inline",
        midClick: !0,
        removalDelay: 300,
        alignTop: !0,
        mainClass: "mfp-fade"
    }), $(".open-image-code-modal").magnificPopup({
        type: "inline",
        midClick: !0,
        removalDelay: 300,
        alignTop: !0,
        mainClass: "mfp-fade"
    }), $(".open-photo-processing-modal").magnificPopup({
        type: "inline",
        midClick: !0,
        removalDelay: 300,
        alignTop: !0,
        mainClass: "mfp-fade"
    }), $(".open_ajax_popup").magnificPopup({
        type: "ajax",
        alignTop: !0,
        overflowY: "scroll"
    })
...
function () {
    $(function () {
        ...
        return $(".brand").click(function () {
            return $(".brand_desc").slideToggle(400).delay(400)
        }), $(".hover_pulse").hover(function () {
            return $(".pulse").toggle()
        }), $(".right_link").click(function () {
            return $(".right_hidden").slideToggle(400)
        }), $("#card_submit").submit(function () {
            return $("#image_loader").delay("fast").fadeIn()
        }), $("#upfile").change(function () {
            return $(".uploading_spinner").show(), this.form.submit()
        }), $("#profile_upfile").change(function () {
            return $(".profile_uploading_spinner").show(), this.form.submit()
        }), $("#cover_upfile").change(function () {
            return $(".uploading_spinner").show(), this.form.submit()
        }), $("#banner_upfile").change(function () {
            return $(".uploading_spinner").show(), this.form.submit()
        }), $("#logo_format_circle").click(function () {
            return $(".circle_check").delay("fast").fadeIn(), $(".square_check").delay("fast").fadeOut(), $("#setting_logo_shape").val("Circle")
        }), $("#logo_format_square").click(function () {
            return $(".circle_check").delay("fast").fadeOut(), $(".square_check").delay("fast").fadeIn(), $("#setting_logo_shape").val("Square")
        }), $(".custom_domain_input").click(function () {
            return $(".domain_explanation").slideDown(400)
        }), $(".toggle_distractions").click(function () {
            return $(".ui_elements").toggle(400)
        }), $("#select_silvrback_icon").click(function () {
            return $(".select_silvrback_icon").slideDown(), $(".select_personal_icon").fadeOut(), $(".select_initials_icon").fadeOut()
        }), $("#select_personal_icon").click(function () {
            return $(".select_personal_icon").slideDown(), $(".select_silvrback_icon").fadeOut(), $(".select_initials_icon").fadeOut()
        }), $("#select_initials_icon").click(function () {
            return $(".select_initials_icon").slideDown(), $(".select_silvrback_icon").fadeOut(), $(".select_personal_icon").fadeOut()
        }), $("#top_logo_initials").change(function () {
            return $("#setting_logo_initials").val($(this).val())
        }), $('input[name="icon_type"]').change(function () {
            return $("#setting_icon_type").val($(this).val())
        }), $(".settings_save").click(function () {
            return $(".settings_save").hide(), $(".settings_process").show()
        }), $(".article_order").sortable({
            axis: "y",
            update: function () {
        ...
        }), $(".category_items_order").sortable({
            axis: "y",
            update: function () {
                return $.post($(this).data("update-url"), $(this).sortable("serialize"))
            }
        }), $(".color_order").sortable({
            axis: "y",
            update: function () {
                return $.post($(this).data("update-url"), $(this).sortable("serialize"))
            }
            ...
            top: "auto",
            left: "auto"
        }, n = document.getElementById("image_loader"), e = new Spinner(t).spin(n), s = document.getElementById("spinner_circle"), i = new Spinner(t).spin(s), imagesLoaded($(".main_content"), function () {
            return $("#image_loader").delay("fast").fadeOut(), $(".fade_image").delay("slow").fadeIn()
        })
    })
}.call(this), $(document).ready(function () {
    function t() {
        $(".article_flash").css("position", "absolute"), $(".article_flash").animate({
            top: -200
        }, 1500)
    }
    $(".article_flash").length && setTimeout(t, 2e3), $("input, textarea").placeholder();
    var e;
    $(".theme_wrapper").click(function () {
        $(".comments").length && 1 == e && ($(".comments").toggle("slide", {
            direction: "left"
        }, 500), e = 0)
    ...
    }), $(".comment_link").click(function (t) {
        $(".comments").toggle("slide", {
            direction: "left"
        }, 500), e = 1, t.stopPropagation()
    }), $(".new_email_subscription").submit(function () {
        $(".spinner").fadeIn()
    }), imagesLoaded($(".banner_container"), function () {
        $(".user_banner").css("display", "block"), $(".user_banner").addClass("fadeInDown")
    })
}), $(window).load(function () {
    $(".hidden_menu").show(), $(".spinning_icon").length && setTimeout(function () {
        $(".silvrback_menu").removeClass("spinning_icon")
    }, 500)
}), $(document).ready(function () {
    if ($(".social").length) {
        var t = 0;
        $(window).width() >= 800 ? $(".social").toggle(700) : t = 1, $(window).resize(function () {
            $(window).width() <= 800 ? ($(".social").hide(700), t = 1) : (t = 0, $(".social").show(700))
        })
    }
}),
function (t) {
...
function (t, e, i) {
    ...
    l && h ? (a = u.placeholder = function () {
        ...
        set: function (t, n) {
            ...
            return a ? a[0].value = n : r.data("placeholder-enabled") ? ("" == n ? (t.value = n, t != e.activeElement && o.call(t)) : r.hasClass("placeholder") ? s.call(t, !0, n) || (t.value = n) : t.value = n, r) : t.value = n
        }
    }, l || (c.input = r, d.value = r), h || (c.textarea = r, d.value = r), i(function () {
...
! function (t, e, i, n) {
    ...
    function r(e) {
        if (e)
            for (var i = (new Date).getTime(), s = 0, o = t.velocity.State.calls.length; o > s; s++)
                if (t.velocity.State.calls[s]) {
                    var l = t.velocity.State.calls[s],
                        d = l[0],
                        p = l[2],
                        f = l[3];
                    f || (f = t.velocity.State.calls[s][3] = i - 16);
                    for (var m = Math.min((i - f) / p.duration, 1), g = 0, v = d.length; v > g; g++) {
                        var y = d[g],
                            b = y.element;
                        if (t.data(b, u)) {
                            var _ = !1;
                            p.display && "none" !== p.display && (c.setPropertyValue(b, "display", p.display), t.velocity.State.calls[s][2].display = !1);
                            for (var w in y)
                                if ("element" !== w) {
                                    var x, C = y[w],
                                        k = C.currentValue;
                                    if (1 === m) x = /^(top|bottom|right|left)$/.test(w) && 0 === C.endValue ? "auto" : C.endValue;
                                    else if (x = C.startValue + (C.endValue - C.startValue) * t.easing[C.easing](m), !/translate/i.test(w) && m > .2 && .8 > m && ("px" === C.unitType || "" === C.unitType) && Math.abs((x - k) / k) < .005) break;
                                    if (C.currentValue = x, c.Hooks.registered[w]) {
                                        var T = c.Hooks.getRoot(w),
                                            D = t.data(b, u).rootPropertyValueCache[T];
                                        D && (C.rootPropertyValue = D)
                                    }
                                    var S = c.setPropertyValue(b, w, C.currentValue + ("auto" === x ? "" : C.unitType), C.rootPropertyValue);
                                    c.Hooks.registered[w] && (t.data(b, u).rootPropertyValueCache[T] = c.Normalizations.registered[T] ? c.Normalizations.registered[T]("extract", null, S[1]) : S[1]), "transform" === S[0] && (_ = !0)
                                }
                            p.mobileHA && (t.data(b, u).transformCache.translate3d === n ? (t.data(b, u).transformCache.translate3d = "(0, 0, 0)", _ = !0) : 1 === m && (delete t.data(b, u).transformCache.translate3d, _ = !0)), _ && c.flushTransformCache(b)
                        }
                    }
                    1 === m && a(s)
                }
        t.velocity.State.isTicking && h(r)
    }

    function a(e) {
        for (var i = t.velocity.State.calls[e][0], s = t.velocity.State.calls[e][1], o = t.velocity.State.calls[e][2], r = !1, a = 0, l = i.length; l > a; a++) {
            var h = i[a].element;
            "none" === o.display && o.loop === !1 && c.setPropertyValue(h, "display", o.display), t.queue(h)[1] !== n && /\$\.velocity\.queueEntryFlag/i.test(t.queue(h)[1]) || t.data(h, u) && (t.data(h, u).isAnimating = !1, t.data(h, u).rootPropertyValueCache = {}), t.dequeue(h)
        }
        t.velocity.State.calls[e] = !1;
        for (var d = 0, p = t.velocity.State.calls.length; p > d; d++)
            if (t.velocity.State.calls[d] !== !1) {
                r = !0;
                break
            }
        r === !1 && (t.velocity.State.isTicking = !1, delete t.velocity.State.calls, t.velocity.State.calls = []), o.complete && o.complete.call(s)
    }
    var l = function () {
        ...
        h = e.requestAnimationFrame || function () {
            var t = 0;
    ...
    if (7 >= l) return void(t.fn.velocity = t.fn.animate);
    if (t.velocity !== n || t.fn.velocity !== n) return void console.log("Velocity is already loaded or its namespace is occupied.");
    ! function () {
        var e = {};
        t.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (t, i) {
            e[i] = function (e) {
    ...
    t.velocity = {
        ...
        animate: function () {},
        debug: !1
    }, e.pageYOffset !== n ? (t.velocity.State.scrollAnchor = e, t.velocity.State.scrollProperty = "pageYOffset") : (t.velocity.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body, t.velocity.State.scrollProperty = "scrollTop"), t.velocity.Classes.extract = function () {
        for (var e = i.styleSheets, n = {}, s = 0, o = e.length; o > s; s++) {
            var r, a = e[s];
            try {
                if (!a.cssText && !a.cssRules) continue;
                r = a.cssText ? a.cssText.replace(/[\r\n]/g, "").match(/[^}]+\{[^{]+\}/g) : a.cssRules;
                for (var l = 0, h = r.length; h > l; l++) {
                    var u;
                    if (a.cssText) u = r[l];
                    else {
                        if (!r[l].cssText) continue;
                        u = r[l].cssText
                    }
                    var c = u.match(/\.animate_([A-z0-9_-]+)(?:(\s+)?{)/);
                    if (c) {
                        var d = c[1],
                            p = u.toLowerCase().match(/\{([\S\s]*)\}/)[1].match(/[A-z-][^;]+/g);
                        n[d] || (n[d] = {});
        ...
        return t.velocity.Classes.extracted = n, t.velocity.debug && console.log("Classes: " + JSON.stringify(t.velocity.Classes.extracted)), n
    }, t.velocity.Classes.extract();
    var c = t.velocity.CSS = {
        RegEx: {
            valueUnwrap: /^[A-z]+\((.*)\)$/i,
        ...
        Hooks: {
            ...
            register: function () {
                var t, e, i;
                if (l)
                    for (t in c.Hooks.templates) {
                        e = c.Hooks.templates[t], i = e[0].split(" ");
                        var n = e[1].match(c.RegEx.valueSplit);
                        "Color" === i[0] && (i.push(i.shift()), n.push(n.shift()), c.Hooks.templates[t] = [i.join(" "), n.join(" ")])
                    }
                for (t in c.Hooks.templates) {
                    e = c.Hooks.templates[t], i = e[0].split(" ");
                    for (var s in i) {
            ...
            cleanRootPropertyValue: function (t, e) {
                return c.RegEx.valueUnwrap.test(e) && (e = e.match(c.Hooks.RegEx.valueUnwrap)[1]), c.Values.isCSSNullValue(e) && (e = c.Hooks.templates[t][1]), e
            },
            extractValue: function (t, e) {
                ...
                if (i) {
                    var n = i[0],
                        s = i[1];
                    return e = c.Hooks.cleanRootPropertyValue(n, e), e.toString().match(c.RegEx.valueSplit)[s]
                }
                return e
            },
            injectValue: function (t, e, i) {
                ...
                if (n) {
                    var s, o, r = n[0],
                        a = n[1];
                    return i = c.Hooks.cleanRootPropertyValue(r, i), s = i.toString().match(c.RegEx.valueSplit), s[a] = e, o = s.join(" ")
                }
                return i
            }
        },
        Normalizations: {
            registered: {
                clip: function (t, e, i) {
                    ...
                    case "extract":
                        var n;
                        return c.RegEx.wrappedValueAlreadyExtracted.test(i) ? n = i : (n = i.toString().match(c.RegEx.valueUnwrap), n && (n = n[1].replace(/,(\s+)?/g, " "))), n;
                    case "inject":
                        return "rect(" + i + ")"
                    }
                },
                opacity: function (t, e, i) {
                    ...
                    case "inject":
                        return e.style.zoom = 1, "alpha(opacity=" + parseInt(100 * i) + ")"
                    } else switch (t) {
                    case "name":
                        return "opacity";
                    case "extract":
            ...
            register: function () {
                function e(t) {
                    ...
                    return t = t.replace(i, function (t, e, i, n) {
                        return e + e + i + i + n + n
                    }), e = n.exec(t), e ? "rgb(" + (parseInt(e[1], 16) + " " + parseInt(e[2], 16) + " " + parseInt(e[3], 16)) + ")" : "rgb(0 0 0)"
                }
                var i = ["translateX", "translateY", "scale", "scaleX", "scaleY", "skewX", "skewY", "rotateZ"];
                9 >= l || (i = i.concat(["translateZ", "scaleZ", "rotateX", "rotateY"]));
                for (var s = 0, o = i.length; o > s; s++)! function () {
                    var e = i[s];
                    c.Normalizations.registered[e] = function (i, s, o) {
                        switch (i) {
                        case "name":
                            return "transform";
                        case "extract":
                            return t.data(s, u).transformCache[e] === n ? /^scale/i.test(e) ? 1 : 0 : t.data(s, u).transformCache[e].replace(/[()]/g, "");
                        case "inject":
                            var r = !1;
                            switch (e.substr(0, e.length - 1)) {
                            case "translate":
                                r = !/(%|px|em|rem|\d)$/i.test(o);
                                break;
                            case "scale":
                                r = !/(\d)$/i.test(o);
                                break;
                            ...
                            return r || (t.data(s, u).transformCache[e] = "(" + o + ")"), t.data(s, u).transformCache[e]
                        }
                    }
                }();
                for (var r = ["color", "backgroundColor", "borderColor", "outlineColor"], s = 0, a = r.length; a > s; s++)! function () {
                    var t = r[s];
                    c.Normalizations.registered[t] = function (i, s, o) {
                        switch (i) {
                        case "name":
                            return t;
                        case "extract":
                            ...
                            if (c.RegEx.wrappedValueAlreadyExtracted.test(o)) r = o;
                                ...
                                /^[A-z]+$/i.test(o) ? a = h[o] !== n ? h[o] : h.black : /^#([A-f\d]{3}){1,2}$/i.test(o) ? a = e(o) : /^rgba?\(/i.test(o) || (a = h.black), r = (a || o).toString().match(c.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                            }
                            return 8 >= l || 3 !== r.split(" ").length || (r += " 1"), r;
                        case "inject":
                            return 8 >= l ? 4 === o.split(" ").length && (o = o.split(/\s+/).slice(0, 3).join(" ")) : 3 === o.split(" ").length && (o += " 1"), (8 >= l ? "rgb" : "rgba") + "(" + o.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                        }
                    }
                }()
            }
        ...
        Names: {
            ...
            prefixCheck: function (e) {
                if (t.velocity.State.prefixMatches[e]) return [t.velocity.State.prefixMatches[e], !0];
                for (var i = ["", "Webkit", "Moz", "ms", "O"], n = 0, s = i.length; s > n; n++) {
                    var o;
                    if (o = 0 === n ? e : i[n] + e.replace(/^\w/, function (t) {
                        return t.toUpperCase()
                    }), "string" == typeof t.velocity.State.prefixElement.style[o]) return t.velocity.State.prefixMatches[e] = o, [o, !0]
                }
                return [e, !1]
            }
        },
        Values: {
            ...
            getUnitType: function (t) {
                return /^(rotate|skew)/i.test(t) ? "deg" : /(^(scale|scaleX|scaleY|scaleZ|opacity|alpha|fillOpacity|flexGrow|flexHeight|zIndex|fontWeight)$)|color/i.test(t) ? "" : "px"
            }
        },
        getPropertyValue: function (i, s, o, r) {
            function a(i, s) {
                if (!r) {
                    if ("height" === s && "border-box" !== c.getPropertyValue(i, "boxSizing").toLowerCase()) return i.offsetHeight - (parseFloat(c.getPropertyValue(i, "borderTopWidth")) || 0) - (parseFloat(c.getPropertyValue(i, "borderBottomWidth")) || 0) - (parseFloat(c.getPropertyValue(i, "paddingTop")) || 0) - (parseFloat(c.getPropertyValue(i, "paddingBottom")) || 0);
                    if ("width" === s && "border-box" !== c.getPropertyValue(i, "boxSizing").toLowerCase()) return i.offsetWidth - (parseFloat(c.getPropertyValue(i, "borderLeftWidth")) || 0) - (parseFloat(c.getPropertyValue(i, "borderRightWidth")) || 0) - (parseFloat(c.getPropertyValue(i, "paddingLeft")) || 0) - (parseFloat(c.getPropertyValue(i, "paddingRight")) || 0)
                }
                var o = 0;
                if (8 >= l) o = t.css(i, s);
                else {
                    var h;
                    h = t.data(i, u) === n ? e.getComputedStyle(i, null) : t.data(i, u).computedStyle ? t.data(i, u).computedStyle : t.data(i, u).computedStyle = e.getComputedStyle(i, null), l && "borderColor" === s && (s = "borderTopColor"), o = 9 === l && "filter" === s ? h.getPropertyValue(s) : h[s], "" === o && (o = i.style[s])
                } if ("auto" === o && /^(top|right|bottom|left)$/i.test(s)) {
                    var d = a(i, "position");
                    ("fixed" === d || "absolute" === d && /top|left/i.test(s)) && (o = t(i).position()[s] + "px")
                }
                return o
            }
            var h;
            if (c.Hooks.registered[s]) {
                var d = s,
                    p = c.Hooks.getRoot(d);
                o === n && (o = c.getPropertyValue(i, c.Names.prefixCheck(p)[0])), c.Normalizations.registered[p] && (o = c.Normalizations.registered[p]("extract", i, o)), h = c.Hooks.extractValue(d, o)
            } else if (c.Normalizations.registered[s]) {
                var f, m;
                f = c.Normalizations.registered[s]("name", i), "transform" !== f && (m = a(i, c.Names.prefixCheck(f)[0]), c.Values.isCSSNullValue(m) && c.Hooks.templates[s] && (m = c.Hooks.templates[s][1])), h = c.Normalizations.registered[s]("extract", i, m)
            }
            return /^[\d-]/.test(h) || (h = a(i, c.Names.prefixCheck(s)[0])), c.Values.isCSSNullValue(h) && (h = 0), t.velocity.debug >= 2 && console.log("Get " + s + ": " + h), h
        },
        setPropertyValue: function (i, n, s, o) {
            var r = n;
            if ("scroll" === n) e.scrollTo(null, s);
            else if (c.Normalizations.registered[n] && "transform" === c.Normalizations.registered[n]("name", i)) c.Normalizations.registered[n]("inject", i, s), r = "transform", s = t.data(i, u).transformCache[n];
            else {
                if (c.Hooks.registered[n]) {
                    var a = n,
                        h = c.Hooks.getRoot(n);
                    o = o || c.getPropertyValue(i, h), s = c.Hooks.injectValue(a, s, o), n = h
                }
                if (c.Normalizations.registered[n] && (s = c.Normalizations.registered[n]("inject", i, s), n = c.Normalizations.registered[n]("name", i)), r = c.Names.prefixCheck(n)[0], 8 >= l) try {
                    i.style[r] = s
                } catch (d) {
                    console.log("Error setting [" + r + "] to [" + s + "]")
                } else i.style[r] = s;
                t.velocity.debug >= 2 && console.log("Set " + n + " (" + r + "): " + s)
            }
            return [r, s]
        },
        flushTransformCache: function (e) {
            var i, n, s = "";
            for (i in t.data(e, u).transformCache) n = t.data(e, u).transformCache[i], 9 === l && "rotateZ" === i && (i = "rotate"), s += i + n + " ";
            c.setPropertyValue(e, "transform", s)
        }
    };
    c.Hooks.register(), c.Normalizations.register(), t.fn.velocity = t.velocity.animate = function () {
        function e() {
            var e = this,
                a = t.extend({}, t.fn.velocity.defaults, t.data(e, "uiVelocityOptions"), d),
                f = {};
            if ("stop" === p) return t.queue(e, "string" == typeof d ? d : "", []), !0;
            switch (t.data(e, u) === n && t.data(e, u, {
                isAnimating: !1,
                computedStyle: null,
            ...
            case "slow":
                ...
                break;
            default:
                a.duration = parseFloat(a.duration) || parseFloat(t.fn.velocity.defaults.duration) || 400
            }
            t.easing[a.easing] || (a.easing = t.easing[t.fn.velocity.defaults.easing] ? t.fn.velocity.defaults.easing : "swing"), /^\d/.test(a.delay) && t.queue(e, a.queue, function (e) {
                t.velocity.queueEntryFlag = !0, setTimeout(e, parseFloat(a.delay))
            }), a.display && (a.display = a.display.toLowerCase()), a.mobileHA = a.mobileHA && t.velocity.State.isMobile, t.queue(e, a.queue, function (m) {
                function _(i) {
                    var s = n,
                        r = n,
                        l = n;
                    return "[object Array]" === Object.prototype.toString.call(i) ? (s = i[0], /^[\d-]/.test(i[1]) || o(i[1]) ? l = i[1] : "string" == typeof i[1] && (t.easing[i[1]] !== n && (r = i[1]), i[2] && (l = i[2]))) : s = i, r = r || a.easing, o(s) && (s = s.call(e, v, g)), o(l) && (l = l.call(e, v, g)), [s || 0, r, l]
                }
                ...
                function w(t, e) {
                    ...
                    return n = (e || 0).toString().toLowerCase().replace(/[%A-z]+$/, function (t) {
                        return i = t, ""
                    }), i || (i = c.Values.getUnitType(t)), [n, i]
                }
                ...
                function x() {
                    var n = {
                        ...
                        s = n.position === y.lastPosition && n.parent === y.lastParent,
                        o = n.fontSize === y.lastFontSize;
                    y.lastParent = n.parent, y.lastPosition = n.position, y.lastFontSize = n.fontSize, null === y.remToPxRatio && (y.remToPxRatio = parseFloat(c.getPropertyValue(i.body, "fontSize")) || 16);
                    var r = {
                            overflowX: null,
                            overflowY: null,
                            boxSizing: null,
                        ...
                        a = {},
                        l = 10;
                    a.remToPxRatio = y.remToPxRatio, r.overflowX = c.getPropertyValue(e, "overflowX"), r.overflowY = c.getPropertyValue(e, "overflowY"), r.boxSizing = c.getPropertyValue(e, "boxSizing"), r.width = c.getPropertyValue(e, "width", null, !0), r.minWidth = c.getPropertyValue(e, "minWidth"), r.maxWidth = c.getPropertyValue(e, "maxWidth") || "none", r.height = c.getPropertyValue(e, "height", null, !0), r.minHeight = c.getPropertyValue(e, "minHeight"), r.maxHeight = c.getPropertyValue(e, "maxHeight") || "none", r.paddingLeft = c.getPropertyValue(e, "paddingLeft"), s ? (a.percentToPxRatioWidth = y.lastPercentToPxWidth, a.percentToPxRatioHeight = y.lastPercentToPxHeight) : (c.setPropertyValue(e, "overflowX", "hidden"), c.setPropertyValue(e, "overflowY", "hidden"), c.setPropertyValue(e, "boxSizing", "content-box"), c.setPropertyValue(e, "width", l + "%"), c.setPropertyValue(e, "minWidth", l + "%"), c.setPropertyValue(e, "maxWidth", l + "%"), c.setPropertyValue(e, "height", l + "%"), c.setPropertyValue(e, "minHeight", l + "%"), c.setPropertyValue(e, "maxHeight", l + "%")), o ? a.emToPxRatio = y.lastEmToPx : c.setPropertyValue(e, "paddingLeft", l + "em"), s || (a.percentToPxRatioWidth = y.lastPercentToPxWidth = (parseFloat(c.getPropertyValue(e, "width", null, !0)) || 0) / l, a.percentToPxRatioHeight = y.lastPercentToPxHeight = (parseFloat(c.getPropertyValue(e, "height", null, !0)) || 0) / l), o || (a.emToPxRatio = y.lastEmToPx = (parseFloat(c.getPropertyValue(e, "paddingLeft")) || 0) / l);
                    for (var h in r) c.setPropertyValue(e, h, r[h]);
                    return t.velocity.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(a), e), a
                }
                if (t.velocity.queueEntryFlag = !0, "scroll" === p) {
                    var C = t.velocity.State.scrollAnchor[t.velocity.State.scrollProperty],
                    ...
                    if (!t.data(e, u).tweensContainer) return void t.dequeue(e, a.queue);
                    "none" === t.data(e, u).opts.display && (t.data(e, u).opts.display = "block"), t.data(e, u).opts.loop = !1, a = t.extend({}, t.data(e, u).opts, d);
                    var T = t.extend(!0, {}, t.data(e, u).tweensContainer);
                    for (var D in T)
                        if ("element" !== D) {
                            var S = T[D].startValue;
                            T[D].startValue = T[D].currentValue = T[D].endValue, T[D].endValue = S, d && (T[D].easing = a.easing)
                        }
                    f = T
                } else if ("start" === p) {
                    var T;
                    t.data(e, u).tweensContainer && t.data(e, u).isAnimating === !0 && (T = t.data(e, u).tweensContainer);
                    for (var P in h) {
                        P = c.Names.camelCase(P);
                        var I = _(h[P]),
                            E = I[0],
                            M = I[1],
                            A = I[2],
                            z = c.Hooks.getRoot(P),
                            N = !1;
                        if (c.Names.prefixCheck(z)[1] !== !1 || c.Normalizations.registered[z] !== n) {
                            a.display && "none" !== a.display && /opacity|filter/.test(P) && !A && 0 !== E && (A = 0), a._cacheValues && T && T[P] ? (A = T[P].endValue + T[P].unitType, N = t.data(e, u).rootPropertyValueCache[z]) : c.Hooks.registered[P] ? A === n ? (N = c.getPropertyValue(e, z), A = c.getPropertyValue(e, P, N)) : N = c.Hooks.templates[z][1] : A === n && (A = c.getPropertyValue(e, P));
                            var H, O, W, L;
                            H = w(P, A), A = H[0], W = H[1], H = w(P, E), E = H[0].replace(/^([+-\/*])=/, function (t, e) {
                                return L = e, ""
                            }), O = H[1], A = parseFloat(A) || 0, E = parseFloat(E) || 0;
                            var j;
                            if ("%" === O && (/^(fontSize|lineHeight)$/.test(P) ? (E /= 100, O = "em") : /^scale/.test(P) ? (E /= 100, O = "") : /(Red|Green|Blue)$/i.test(P) && (E = 255 * (E / 100), O = "")), /[\/*]/.test(L)) O = W;
                            else if (W !== O && 0 !== A)
                                if (0 === E) O = W;
                                else {
                                    j = j || x();
                                    var R = /margin|padding|left|right|width|text|word|letter/i.test(P) || /X$/.test(P) ? "x" : "y";
                                    switch (W) {
                                    case "%":
                                        A *= "x" === R ? j.percentToPxRatioWidth : j.percentToPxRatioHeight;
                                        break;
                                    case "em":
                                        A *= j.emToPxRatio;
                                        break;
                                    ...
                                    switch (O) {
                                    case "%":
                                        A *= 1 / ("x" === R ? j.percentToPxRatioWidth : j.percentToPxRatioHeight);
                                        break;
                                    case "em":
                                        A *= 1 / j.emToPxRatio;
                                        break;
                            ...
                            f[P] = {
                                ...
                                unitType: O,
                                easing: M
                            }, t.velocity.debug && console.log("tweensContainer (" + P + "): " + JSON.stringify(f[P]), e)
                        } else t.velocity.debug && console.log("Skipping [" + z + "] due to a lack of browser support.")
                    }
                    f.element = e
                }
                f.element && (b.push(f), t.data(e, u).tweensContainer = f, t.data(e, u).opts = a, t.data(e, u).isAnimating = !0, v === g - 1 ? (t.velocity.State.calls.length > 1e4 && (t.velocity.State.calls = s(t.velocity.State.calls)), t.velocity.State.calls.push([b, l, a]), t.velocity.State.isTicking === !1 && (t.velocity.State.isTicking = !0, r())) : v++), "" !== a.queue && "fx" !== a.queue && setTimeout(m, a.duration + a.delay)
            }), (a.queue === !1 || ("" === a.queue || "fx" === a.queue) && "inprogress" !== t.queue(e)[0]) && t.dequeue(e)
        }
        var a, l, h, d;
        this.jquery ? (a = !0, l = this, h = arguments[0], d = arguments[1]) : (a = !1, l = arguments[0], h = arguments[1], d = arguments[2]);
        var p;
        switch (h) {
        case "scroll":
            p = "scroll";
        ...
        case "stop":
            ...
            break;
        default:
            if (t.isPlainObject(h) && !t.isEmptyObject(h)) p = "start";
            else {
                if ("string" != typeof h || !t.velocity.Classes.extracted[h]) return t.velocity.debug && console.log("First argument was not a property map, a CSS class reference, or a known action. Aborting."), l;
                h = t.velocity.Classes.extracted[h], p = "start"
            }
        }
        if ("stop" !== p && "object" != typeof d) {
            var f = a ? 1 : 2;
            d = {};
            for (var m = f; m < arguments.length; m++) /^\d/.test(arguments[m]) ? d.duration = parseFloat(arguments[m]) : "string" == typeof arguments[m] ? d.easing = arguments[m].replace(/^\s+|\s+$/g, "") : o(arguments[m]) && (d.complete = arguments[m])
        }
        var g = l.length || 1,
            v = 0,
            y = {
            ...
            b = [];
        if (d && !o(d.complete) && (d.complete = null), a) l.each(e);
        else if (l.nodeType) e.call(l);
        else if (l[0] && l[0].nodeType)
            for (var _ in l) e.call(l[_]);
        var w = t.extend({}, t.fn.velocity.defaults, d);
        if (w.loop = parseInt(w.loop), w.loop)
            for (var x = 0; x < 2 * w.loop - 1; x++) a ? l.velocity("reverse", {
                delay: w.delay
            }) : t.velocity.animate(l, "reverse", {
                delay: w.delay
            });
        return l
    }
}(jQuery, window, document), $.fn.velocity.defaults = {
    queue: "",
    duration: 400,
    easing: "swing",
    complete: null,
